...
public final class TestInfrastructure {
    ...
    public static String jdbcUrl() { return "jdbc:postgresql://" + POSTGRES.getHost() + ":" + POSTGRES.getMappedPort(5432) + "/auth_test"; }
    public static String username() { return "auth_test"; }
    public static String password() { return "test-only"; }
    public static String redisHost() { return REDIS.getHost(); }
    public static int redisPort() { return REDIS.getMappedPort(6379); }
    public static String redisUri() { return "redis://" + redisHost() + ":" + redisPort(); }
    public static Connection connection() throws SQLException { return DriverManager.getConnection(jdbcUrl(), username(), password()); }
}
