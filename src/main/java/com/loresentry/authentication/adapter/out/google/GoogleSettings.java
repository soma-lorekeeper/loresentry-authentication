...
public record GoogleSettings(String clientId, String clientSecret, String redirectUri) {
    public static GoogleSettings validated(String id, String secret, String redirect, boolean local) {
        try {
        ...
        } catch (RuntimeException e) { throw new IllegalStateException("Invalid Google OAuth configuration"); }
    }
